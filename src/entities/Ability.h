...
class Ability {
 public:
  Ability(sf::Texture& texture,
          ...
          float frameDuration,
          int dmgFrame,
          AbilityLocationData locationData,
          float scale = 2.f)
      : m_sprite(texture),
        m_position(locationData.mousePosition),
    ...
    m_hitbox = sf::FloatRect({locationData.mousePosition.x - (scaledWidth / 2.f) - locationData.hitboxOffset.x,
